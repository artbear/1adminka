Процедура ДобавитьОбщиеПараметрыКоманд(Знач Парсер) Экспорт
	Парсер.ДобавитьИменованныйПараметр(ПараметрыСистемы.ОбщиеПараметрыКоманд().Каталог, "Каталог сборки. Путь временного или постоянного каталога сборки, в котором будут созданы необходимые файлы", Истина);
