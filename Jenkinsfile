...
node("slave") {
    ...
    stage "checkout 1bdd"
    checkout([$class: 'GitSCM', branches: [[name: '*/develop']], doGenerateSubmoduleConfigurations: false, extensions: [[$class: 'RelativeTargetDirectory', relativeTargetDir: '1bdd']], submoduleCfg: [], userRemoteConfigs: [[url: 'https://github.com/artbear/1bdd.git']]])
    ...
    command = """oscript ./1bdd/src/bdd.os ./features -out ./bdd-exec.log"""
